...
/**
 *  
 *  Implements SimpleBGC API https://www.basecamelectronics.com/serialapi/ 
 *  define all The parameters
 *
 */
public class API {
	
	//0 data input: Still need a byte array 
	...
	public static double g=9.7639;
	public static double factor=0.06103701895;
